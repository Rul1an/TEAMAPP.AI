-- =============================================
-- COMPLETE SUPABASE FOUNDATION MIGRATION 2025
-- Creates ALL required infrastructure before any app migrations
-- Timestamp: 20250630 - runs before all existing migrations
-- =============================================
...
-- Organization members table (replaces memberships)
...
-- Memberships table (for backwards compatibility)
...
-- Videos table (COMPLETE schema with all expected columns)
...
-- Video tags table (COMPLETE schema with ALL expected columns)
...
BEGIN
  ...
  RAISE NOTICE 'ℹ️ Storage tables will be handled by Supabase';
  RAISE NOTICE '==============================================';
END
$$;

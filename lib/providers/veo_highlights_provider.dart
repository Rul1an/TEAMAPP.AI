...
final veoHighlightsProvider = FutureProvider.family.autoDispose<
    List<VeoHighlight>, String>((ref, matchId) async {
...
final highlightPlaybackUrlProvider = FutureProvider.family.autoDispose<
    String, String>((ref, highlightId) async {
  final repo = ref.watch(_veoRepositoryProvider);

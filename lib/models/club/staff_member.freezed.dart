...
// Documents
  ...
  @override
  String toString() {
    return 'StaffMember(id: $id, clubId: $clubId, firstName: $firstName, lastName: $lastName, email: $email, primaryRole: $primaryRole, permissions: $permissions, availability: $availability, status: $status, createdAt: $createdAt, middleName: $middleName, nickname: $nickname, phone: $phone, emergencyContact: $emergencyContact, emergencyPhone: $emergencyPhone, street: $street, city: $city, postalCode: $postalCode, country: $country, additionalRoles: $additionalRoles, employeeNumber: $employeeNumber, startDate: $startDate, endDate: $endDate, qualifications: $qualifications, certificates: $certificates, teamIds: $teamIds, primaryTeamIds: $primaryTeamIds, hasVOG: $hasVOG, vogExpiryDate: $vogExpiryDate, hasMedicalCertificate: $hasMedicalCertificate, medicalCertificateExpiry: $medicalCertificateExpiry, hasInsurance: $hasInsurance, updatedAt: $updatedAt, createdBy: $createdBy, updatedBy: $updatedBy)';
  }

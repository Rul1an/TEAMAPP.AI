...
_$ClubImpl _$$ClubImplFromJson(Map<String, dynamic> json) => _$ClubImpl(
  ...
  tier: $enumDecodeNullable(_$ClubTierEnumMap, json['tier']) ?? ClubTier.basic,
  teams:
...
_$ClubSettingsImpl _$$ClubSettingsImplFromJson(
  ...
  enableAdvancedAnalytics: json['enableAdvancedAnalytics'] as bool? ?? false,

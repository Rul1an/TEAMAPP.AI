...
// Metadata
  ...
  @override
  String toString() {
    return 'PlayerProgress(id: $id, playerId: $playerId, teamId: $teamId, clubId: $clubId, season: $season, startDate: $startDate, endDate: $endDate, technicalSkills: $technicalSkills, physicalAttributes: $physicalAttributes, tacticalSkills: $tacticalSkills, mentalAttributes: $mentalAttributes, performanceMetrics: $performanceMetrics, goals: $goals, assessments: $assessments, overallRating: $overallRating, coachNotes: $coachNotes, developmentPlan: $developmentPlan, recommendations: $recommendations, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, assessedBy: $assessedBy)';
  }
...
mixin _$DevelopmentGoal {
  ...
  DateTime get targetDate => throw _privateConstructorUsedError; // Progress
  double get currentValue => throw _privateConstructorUsedError;
  double get targetValue => throw _privateConstructorUsedError;
  String? get unit => throw _privateConstructorUsedError; // Status
  GoalStatus get status => throw _privateConstructorUsedError; // Tracking
...
// Metadata
  ...
  @override
  String toString() {
    return 'DevelopmentGoal(id: $id, title: $title, description: $description, category: $category, priority: $priority, targetDate: $targetDate, currentValue: $currentValue, targetValue: $targetValue, unit: $unit, status: $status, milestones: $milestones, createdAt: $createdAt, completedAt: $completedAt, createdBy: $createdBy)';
  }

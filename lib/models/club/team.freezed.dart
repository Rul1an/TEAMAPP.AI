...
mixin _$Team {
  ...
  String get currentSeason => throw _privateConstructorUsedError; // Settings
  TeamSettings get settings => throw _privateConstructorUsedError; // Status
  TeamStatus get status => throw _privateConstructorUsedError; // Metadata
  DateTime get createdAt => throw _privateConstructorUsedError; // Details
  ...
  String? get division => throw _privateConstructorUsedError; // Staff
  ...
  List<String> get captainIds => throw _privateConstructorUsedError;
...
// Players
  ...
  @override
  String toString() {
    return 'Team(id: $id, clubId: $clubId, name: $name, shortName: $shortName, ageCategory: $ageCategory, level: $level, gender: $gender, currentSeason: $currentSeason, settings: $settings, status: $status, createdAt: $createdAt, description: $description, logoUrl: $logoUrl, colors: $colors, league: $league, division: $division, staffIds: $staffIds, headCoachId: $headCoachId, assistantCoachId: $assistantCoachId, teamManagerId: $teamManagerId, playerIds: $playerIds, captainIds: $captainIds, updatedAt: $updatedAt, createdBy: $createdBy, updatedBy: $updatedBy)';
  }

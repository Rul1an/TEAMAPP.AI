...
mixin _$Club {
  ...
  String get shortName => throw _privateConstructorUsedError; // Club Details
  DateTime get foundedDate => throw _privateConstructorUsedError; // Settings
  ...
  List<StaffMember> get staff => throw _privateConstructorUsedError;
...
// SaaS Properties
  ...
  @override
  String toString() {
    return 'Club(id: $id, name: $name, shortName: $shortName, foundedDate: $foundedDate, settings: $settings, status: $status, createdAt: $createdAt, description: $description, logoUrl: $logoUrl, website: $website, email: $email, phone: $phone, street: $street, city: $city, postalCode: $postalCode, country: $country, colors: $colors, motto: $motto, tier: $tier, teams: $teams, staff: $staff, updatedAt: $updatedAt, createdBy: $createdBy, updatedBy: $updatedBy)';
  }

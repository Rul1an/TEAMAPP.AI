...
class PerformanceRating {
  ...
  factory PerformanceRating.fromJson(Map<String, dynamic> json) =>
      PerformanceRating(
        id: json['id'] as String? as String?,
        playerId: json['playerId'] as String as String,
        matchId: json['matchId'] as String? as String?,
        trainingId: json['trainingId'] as String? as String?,
        date: DateTime.parse(json['date'] as String),
        type: RatingType.values.firstWhere((e) => e.name == json['type'] as String as String),
        overallRating: json['overallRating'] as int as int,
        attackingRating: json['attackingRating'] as int? as int?,
        defendingRating: json['defendingRating'] as int? as int?,
        tacticalRating: json['tacticalRating'] as int? as int?,
        workRateRating: json['workRateRating'] as int? as int?,
        technicalRating: json['technicalRating'] as int? as int?,
        coachabilityRating: json['coachabilityRating'] as int? as int?,
        teamworkRating: json['teamworkRating'] as int? as int?,
        notes: json['notes'] as String? as String?,
        coachId: json['coachId'] as String as String,

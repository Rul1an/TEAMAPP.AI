...
class PeriodizationPlan {
  ...
  String? defaultContentDistribution; // JSON string of Map<String, ContentDistribution>
  ...
  static Map<String, dynamic> getRecommendedParameters(PeriodizationModel model, AgeGroup ageGroup) {
    switch (model) {
      case PeriodizationModel.knvbYouth:
        return {
          'totalWeeks': 42,
          'periods': 4,
          'focusAreas': ['Technical Development', 'Tactical Understanding', 'Game Intelligence', 'Competition'],
  ...
  PeriodizationPlan copyWith({
    ...
    copy.defaultIntensityTargets = defaultIntensityTargets ?? this.defaultIntensityTargets;
    copy.defaultContentDistribution = defaultContentDistribution ?? this.defaultContentDistribution;

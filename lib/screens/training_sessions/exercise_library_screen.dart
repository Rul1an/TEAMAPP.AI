...
class _ExerciseLibraryScreenState extends ConsumerState<ExerciseLibraryScreen>
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildMorphocycleIntensityChip(
                'Acquisition',
                TrainingIntensity.acquisition,
                morphocycle,
              ),
              const SizedBox(width: 8),
              _buildMorphocycleIntensityChip(
                'Development',
                TrainingIntensity.development,
                morphocycle,
              ),
              const SizedBox(width: 8),
              _buildMorphocycleIntensityChip(
                'Activation',
                TrainingIntensity.activation,
                morphocycle,
              ),
            ],
          ),
  ...
  List<TrainingExercise> _applyFilters(List<TrainingExercise> exercises) =>
      exercises
          ...
          .where(
            (e) => e.minPlayers <= _playerCount && e.maxPlayers >= _playerCount,
          )
          .toList();
          ...
          child: Column(
            ...
            children: [
              ...
              if (exercise.tacticalFocus != null)
                _buildDetailRow(
                  'Tactical Focus',
                  exercise.tacticalFocus!.displayName,
                ),

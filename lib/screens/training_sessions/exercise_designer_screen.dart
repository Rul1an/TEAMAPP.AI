...
class ExerciseDesignerScreen extends ConsumerStatefulWidget {
  const ExerciseDesignerScreen({super.key, this.sessionId, this.initialType});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: _buildStepContent(designerState)),
        ...
        _buildFormSection(
          ...
          children: [
            ...
            DropdownButtonFormField<ExerciseType>(
              value:
                  state.formData['type'] as ExerciseType? ??
      ...
      children: [
        _buildFormSection(
          ...
          children: [
            ...
            _buildReviewItem(
              'Beschrijving',
              state.formData['description']?.toString() ?? 'Niet ingevuld',
            ),
            _buildReviewItem(
              'Duur',
              '${state.formData['duration'] ?? 15} minuten',
            ),
            _buildReviewItem(
              'Materialen',
            ...
            _buildReviewItem(
              'Doelstellingen',
              state.formData['objectives']?.toString() ?? 'Niet ingevuld',
            ),
            _buildReviewItem(
              'Coaching Punten',
              state.formData['coachingPoints']?.toString() ?? 'Niet ingevuld',
            ),
          ],
        ),
      ],

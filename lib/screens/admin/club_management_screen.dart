...
class _ClubManagementScreenState extends ConsumerState<ClubManagementScreen> {
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      featureService.getTierDisplayName(club.tier.name.toLowerCase()),
                      style: Theme.of(context).textTheme.headlineSmall?.copyWith(
            ...
            _buildLimitItem(
              context,
              'Coaches',
              club.staff.where((s) => s.primaryRole == StaffRole.headCoach).length,
  ...
  Widget _buildLimitItem(BuildContext context, String label, int current, int limit) {
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      isUnlimited ? '$current / Onbeperkt' : '$current / $limit',
                      style: TextStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Club Verwijderen', style: TextStyle(color: Colors.red)),
  ...
  void _editClubInfo(BuildContext context, Club club) {
    // TODO: Implement edit club info
  }

  void _editBranding(BuildContext context) {
    // TODO: Implement edit branding
  }

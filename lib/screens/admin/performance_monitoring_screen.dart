        ...
        Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.monitor_heart, size: 32, color: Colors.blue),
            ),
                          ...
                          bottomTitles: AxisTitles(
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (double value, TitleMeta meta) {
                                const times = ['12:00', '12:05', '12:10', '12:15', '12:20'];
                    ...
                    child: BarChart(
                      BarChartData(
                        ...
                        barGroups: [
                          ...
                          BarChartGroupData(x: 3, barRods: [BarChartRodData(toY: 81, color: Colors.orange)]),
                          BarChartGroupData(x: 4, barRods: [BarChartRodData(toY: 67, color: Colors.blue)]),
                          BarChartGroupData(x: 5, barRods: [BarChartRodData(toY: 45, color: Colors.green)]),
                          BarChartGroupData(x: 6, barRods: [BarChartRodData(toY: 52, color: Colors.green)]),
                        ],
                      ),
                    ),
                  ),

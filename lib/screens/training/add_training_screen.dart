                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          border: OutlineInputBorder(),
                          alignLabelWithHint: true,
                          hintText: 'Bijv. Verbeteren van passing, positiespel, conditie',
                        ),
                        maxLines: 3,
                      ),
                      const SizedBox(height: 16),
  ...
  Future<void> _saveTraining() async {
    ...
    try {
      ...
      final training = Training()
        ...
        ..objectives = _objectivesController.text.isEmpty ? null : _objectivesController.text
        ..coachNotes = _coachNotesController.text.isEmpty ? null : _coachNotesController.text

...
class _TrainingDialogState extends State<TrainingDialog> {
  ...
  void initState() {
    ...
    if (widget.existingTraining != null) {
      ...
      _selectedDate = widget.weekStartDate.add(const Duration(days: 1)); // Default Tuesday
  ...
  Widget build(BuildContext context) => AlertDialog(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                value: _nameController.text.isNotEmpty ? _nameController.text : null,
                ...
                validator: (value) => value?.isEmpty == true ? 'Selecteer een training type' : null,
              ),
              ...
              TextFormField(
                ...
                validator: (value) => value?.isEmpty == true ? 'Voer een naam in' : null,
              ),
              const SizedBox(height: 16),
              ...
              DropdownButtonFormField<String>(
                ...
                validator: (value) => value?.isEmpty == true ? 'Selecteer een locatie' : null,
              ),
              const SizedBox(height: 16),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: Text(widget.existingTraining != null ? 'Bijwerken' : 'Toevoegen'),
        ),
      ],
    );

...
class _PeriodizationTemplateDialogState extends State<PeriodizationTemplateDialog> {
  ...
  List<Widget> _buildPeriodPreview(PeriodizationPlan template) {
    ...
    return List.generate(template.numberOfPeriods, (index) {
      final intensity = intensityProgression[index % intensityProgression.length];

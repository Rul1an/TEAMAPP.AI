...
class _AdvancedAnalyticsScreenState extends ConsumerState<AdvancedAnalyticsScreen> 
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.analytics_outlined, size: 32, color: Colors.blue),
  ...
  Widget _buildEngagementMetric(String title, String value, String change, IconData icon) {
    return Column(
      children: [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.psychology_outlined, color: Colors.purple, size: 24),
